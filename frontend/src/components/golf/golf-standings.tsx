      ...
      <CardContent>
        <Accordion type="multiple">
          {standings.map(entry => {
            ...
            return (
              <AccordionItem key={entry.entryId} value={entry.entryId} className="border-b last:border-b-0">
                <AccordionTrigger
                  className={cn(
                    'py-3 px-2 hover:no-underline hover:bg-muted/50 rounded-md items-center [&>svg]:ml-1',
